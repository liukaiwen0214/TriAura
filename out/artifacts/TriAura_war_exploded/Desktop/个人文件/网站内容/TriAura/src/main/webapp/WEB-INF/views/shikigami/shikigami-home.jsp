...
<%--    <link rel="stylesheet" href="../../../static/css/tiraura.css">--%>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/shikigami/shikigami-home.css">
<%--    <link rel="stylesheet" href="../../../static/css/shikigami/shikigami-home.css">--%>
                ...
                <div class="modal-body">
                    <form id="addTaskForm">
                        <div class="form-group">
                            ...
                            <input type="text" id="taskName" name="taskName" required aria-required="true" placeholder="请输入任务名称">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="customReward" name="customReward" placeholder="如需要自定义奖励类型，请在此输入">
                        </div>

                        <div class="form-group">
                            <label for="rewardAmount">奖励数量</label>
                            <input type="number" id="rewardAmount" name="rewardAmount" min="1" required aria-required="true" placeholder="请输入奖励数量">
                        </div>
                    ...
                    <form id="addActivityForm">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="date" id="activityStartDate" name="startDate" required aria-required="true">
                            </div>
                            <div class="form-group">
            ...
            <div class="resources-grid">
                <div class="resource-stat-card">
                    ...
                    <div class="resource-data">
                        ...
                        <div class="resource-total"><span class="total-label">总量：</span><span class="total-value">12,456</span> <span class="total-change positive">(+12,456)</span></div>
                ...
                <div class="resource-stat-card">
                    ...
                    <div class="resource-data">
                        ...
                        <div class="resource-total"><span class="total-label">总量：</span><span class="total-value">286.5K</span> <span class="total-change positive">(+286.5K)</span></div>
                ...
                <div class="resource-stat-card">
                    ...
                    <div class="resource-data">
                        ...
                        <div class="resource-total"><span class="total-label">总量：</span><span class="total-value">125</span> <span class="total-change positive">(+125)</span></div>
                ...
                <div class="resource-stat-card">
                    ...
                    <div class="resource-data">
                        ...
                        <div class="resource-total"><span class="total-label">总量：</span><span class="total-value">3,234</span> <span class="total-change positive">(+3,234)</span></div>
...
<%--<script src="../../../static/script/tiraura.js"></script>--%>
<%--<script src="../../../static/script/shikigami/shikigami-home.js"></script>--%>
