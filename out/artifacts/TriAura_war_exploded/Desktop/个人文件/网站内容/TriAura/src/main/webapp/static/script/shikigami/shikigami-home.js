/**
 * TriAura 游戏管理首页 - 模块化架构版本
 *
 * 功能模块架构:
 * 1. 甘特图活动管理 - 时间轴显示和活动调度
 * 2. 任务管理系统 - 每日/每周任务追踪
 * 3. 资源管理 - 游戏资源统计和详情展示
 * 4. 弹窗系统 - 模态对话框管理
 * 5. API集成 - 数据获取和导出功能
 ...
 *
 * ID冲突修复记录 (2025-12-05):
 * - 资源筛选时间输入ID修复为: resourceStartDate, resourceEndDate
 * - 活动弹窗时间输入ID修复为: activityStartDate, activityEndDate
 * - 所有相关的JavaScript选择器已更新匹配新的唯一ID
 * - 功能保持完全不变，仅修复了ID冲突问题
 */
